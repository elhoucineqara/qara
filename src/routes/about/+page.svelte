    ...
    <div class="container mx-auto px-4 relative z-10">
      <div class="items-center flex flex-wrap">
        ...
        <div class="w-full mb-8 lg:hidden">
          <h1 class="text-4xl font-bold mb-4 text-cyan-400">{$t('about.title')}</h1>
          <h2 class="text-xl sm:text-2xl mb-2 text-gray-200 font-medium">{$t('about.subtitle')} <b class:typewriter={isTyping} class="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">{displayedText}</b></h2>
        </div>
        ...
        <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto order-2 lg:order-1">
          ...
          <div class="space-y-4 mb-8 sm:mb-10">
            ...
            <p class="flex items-center text-gray-300 hover:transform hover:translate-x-2 transition-transform duration-300 text-sm sm:text-base">
              ...
              <a href="https://wa.me/212637446431" class="hover:text-cyan-400 transition-colors duration-300 break-all">{$t('about.whatsapp')}</a>
            </p>
            <p class="flex items-center text-gray-300 hover:transform hover:translate-x-2 transition-transform duration-300 text-sm sm:text-base">
              <i class="fab fa-linkedin mr-4 text-purple-400 text-lg sm:text-xl"></i>
              <a href="https://www.linkedin.com/in/your-profile" target="_blank" rel="noopener noreferrer" class="hover:text-purple-400 transition-colors duration-300 break-all">{$t('about.linkedin')}</a>
            </p>
            <p class="flex items-center text-gray-300 hover:transform hover:translate-x-2 transition-transform duration-300 text-sm sm:text-base">
